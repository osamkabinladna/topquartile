...
class BasePurgedTimeSeriesPartition(_BaseKFold, metaclass=ABCMeta):
...
class PurgedTimeSeriesPartition(BasePurgedTimeSeriesPartition):
    def split(self, X, y=None, groups=None):
...
class PurgedGroupTimeSeriesPartition(BasePurgedTimeSeriesPartition):
    """
